...
// counter with loader function


function loaderFunc(startVal, currentVal){
...
function MainFunc(){
    ...
    this.cgpa = function(bn, en, math, science, society, rel){
        ...
        if(bn == 0 || en == 0 || math == 0 || science == 0 || society == 0 || rel == 0){
            ...
            return `
                <p class="alert alert-danger mt-3">Your CGPA    : 0.00</p>
                <p class="alert alert-danger mt-3">Your Grade   : F</p>
            `;

        }else{

            return `
                <p class="alert alert-success mt-3">Your CGPA    : ${cgpa.toFixed(2)}</p>
                <p class="alert alert-success mt-3">Your Grade   : ${this.totalGrade(cgpa.toFixed(2))}</p>
            `;
